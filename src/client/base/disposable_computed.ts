...
function disposableComputedDecorator(
  target: any,
  propertyKey: string,
 ...
 */
const disposableComputedExpr = <T extends { dispose(): void }>(
  fn: () => T,
): IComputedValue<T> => {
...
export const disposableComputed: DisposableComputed = function computed(
  arg1: any,
  arg2: any,
) {
